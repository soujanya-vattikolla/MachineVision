...
# detect the Green color from the cube.
...
# inRange function for finding the mask of green pixels 
maskBGR = cv2.inRange(bright,minBGR,maxBGR)

# bitwise_and operation to get the green pixels from the image using the mask.
